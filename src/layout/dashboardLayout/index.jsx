...
import { Back, DocumentFilter, FolderAdd, Home2, Profile2User, Ship } from "iconsax-reactjs";
...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#F5F6FA]">
      ...
      {pathname === '/dashboard' ? <DashboardMainPageHeader name={name} profileImage={profileImage}/> :
        <button
        onClick={() => {
          window.history.back();
        }}
  ...
  return (
    <div className="w-full xl:hidden px-[16px] py-[32px] flex items-center justify-between">
      ...
      <div className="flex flex-col items-center justify-center gap-[4px]">
        <p className="font-[500] text-[16px] text-[#7C7C7C]">
        Welcome aboard 
        </p>
